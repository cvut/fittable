      ...
      if (this.props.type == 'access') {
        return <div className="error-message">
                 ...
                 <p>
                   ...
                   <br /> {CP.translate('errors.access_try')}
        ...
        return <div className="muted-error-message">
        ...
        return <div className="error-message">
                 ...
                 <p>
                   ...
                   <a href='javascript:window.location.reload()'>{CP.translate('errors.connection_refresh')}</a> {CP.translate('errors.connection_part_or')}
                   <a href='#error-muted' onClick={this.props.onMute}>{CP.translate('errors.connection_mutelink')}</a>. {CP.translate('errors.connection_mutelink_partafter')}
                 </p>
               </div>
      } else {
        return <div className="error-message">
                 ...
                 <p className="please">
                   ...
                   <a href='https://github.com/cvut/fittable/issues'><i className='fa fa-github'></i> issue tracker</a>. {CP.translate('errors.help_thanks')}
                 </p>
               </div>
      }
    } else {
